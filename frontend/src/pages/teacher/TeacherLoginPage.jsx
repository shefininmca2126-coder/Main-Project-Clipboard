...
export default function TeacherLoginPage() {
  ...
  return (
    ...
    >
      ...
      {/* Right side: focused faculty login panel */}
      <div
        style={{
          width: '420px',
      ...
      >
        <div style={{ marginBottom: '2rem' }}>
          ...
          <h2 style={{ marginTop: '0.5rem', marginBottom: '0.25rem' }}>Manage your exams</h2>
          <p style={{ margin: 0, fontSize: '0.9rem', color: '#555' }}>
            Sign in with your college email to schedule exams, upload question sets, and monitor submissions.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '0.9rem' }}>
          ...
          <div>
            ...
            <input
              ...
              placeholder={`e.g. name${allowedDomain}`}
              style={{
                width: '100%',
          ...
          <button
            ...
            style={{
              ...
              boxShadow: '0 10px 25px rgba(58, 12, 163, 0.35)',
            }}
          >
        ...
        <div style={{ marginTop: '1.5rem', fontSize: '0.9rem', color: '#555' }}>
          <div>Don&apos;t have a faculty account?</div>
